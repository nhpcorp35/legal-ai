...
class StrategicAnalysisRetrievalTests(unittest.TestCase):
    ...
    def test_motion_packet_reserves_primary_posture_and_agency_records_before_expert_overflow(self):
        ...
        for question in (
            ...
            self.assertIn("613561_2026_MICHAEL_DESOUSA_et_al_v_GEORGE_RENNICK_et_al_ORDER_TO_SHOW_CAUSE_32.pdf", filenames)
            self.assertIn(
                ("613561_2026_MICHAEL_DESOUSA_et_al_v_GEORGE_RENNICK_et_al_ORDER_TO_SHOW_CAUSE_32.pdf", 3),
