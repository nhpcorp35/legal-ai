...
class ReleaseControllerContractTests(unittest.TestCase):
    def test_release_controller_requires_tests_before_deploy(self):
        ...
        self.assertIn("python -m unittest -v test_release_controller_contract test_release_smoke test_motion_answer_contract test_retrieval_audit_visibility", workflow)
