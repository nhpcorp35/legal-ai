    ...
    if TOP_ATTACK_SURFACES_MARKER in question.casefold():
        ...
        if reasoning_mode == "motion_recommendation":
            ...
            if len(direct_agencies) > 1:
                ...
                instructions += f" This record has separate mandatory direct-agency sources: {agency_names}. Return four separate Record support findings before Likely opposition: expert evidence; the nysdec record; the usace record; and visual or measurement evidence. Each agency finding must cite its own direct record; do not combine the agencies into one finding. Nine findings are permitted for this required coverage."
